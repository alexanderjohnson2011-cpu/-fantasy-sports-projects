...
def generate_week1_matchups():
    ...
    matchups = [
        {
            ...
            "teamA": {
                ...
                "starters": [
                    ...
                    {"slot": "RB1", "player": "Saquon Barkley", "position": "RB", "nflTeam": "PHI", "projectedPoints": 16.4, "tier": "Tier 1", "matchupVs": "vs GB (Fri 8:15pm)", "news": "Full featured workload behind elite run-blocking front in Brazil showdown."},
                    {"slot": "RB2", "player": "Derrick Henry", "position": "RB", "nflTeam": "BAL", "projectedPoints": 15.2, "tier": "Tier 1", "matchupVs": "@ KC (Thu 8:20pm)", "news": "Goal-line hammer with high touchdown equity on NFL opening night."},
                    {"slot": "WR1", "player": "Chris Olave", "position": "WR", "nflTeam": "NO", "projectedPoints": 14.1, "tier": "Tier 2", "matchupVs": "vs CAR (Sun 1pm)", "news": "Dominant 31% target share in training camp scrimmages as focal point."},
                    {"slot": "WR2", "player": "Rashee Rice", "position": "WR", "nflTeam": "KC", "projectedPoints": 13.5, "tier": "Tier 2", "matchupVs": "vs BAL (Thu 8:20pm)", "news": "Cleared for full slot snap volume in kickoff clash with Ravens."},
                    {"slot": "TE", "player": "Trey McBride", "position": "TE", "nflTeam": "ARI", "projectedPoints": 14.8, "tier": "Tier 1", "matchupVs": "@ BUF (Sun 1pm)", "news": "Top target earner in Arizona's 12-personnel passing attack."},
                    {"slot": "FLEX1", "player": "Josh Jacobs", "position": "RB", "nflTeam": "GB", "projectedPoints": 13.8, "tier": "Tier 2", "matchupVs": "vs PHI (Fri 8:15pm)", "news": "Early-down bellcow volume locked in for Green Bay backfield."},
                    {"slot": "FLEX2", "player": "Emeka Egbuka", "position": "WR", "nflTeam": "TB", "projectedPoints": 12.2, "tier": "Tier 3", "matchupVs": "vs WAS (Sun 1pm)", "news": "Rookie draft pick ascending into starting 3-receiver sets."},
                    {"slot": "FLEX3", "player": "D'Andre Swift", "position": "RB", "nflTeam": "CHI", "projectedPoints": 11.4, "tier": "Tier 3", "matchupVs": "vs TEN (Sun 1pm)", "news": "Pass-catching back operating in revamped Chicago offensive scheme."},
                    {"slot": "K", "player": "Brandon Aubrey", "position": "K", "nflTeam": "DAL", "projectedPoints": 8.1, "tier": "Tier 1", "matchupVs": "@ CLE (Sun 4:25pm)", "news": "Elite 60+ yard field goal range in high-scoring dome/outdoors."},
                    {"slot": "DEF", "player": "Philadelphia Eagles", "position": "DEF", "nflTeam": "PHI", "projectedPoints": 6.5, "tier": "Tier 2", "matchupVs": "vs GB (Fri)", "news": "Disruptive front four generate strong pressure rate against Love."}
                ]
            },
            "teamB": {
                "rosterId": 9,
        ...
        },
        {
            ...
            "teamB": {
                ...
                "starters": [
                    ...
                    {"slot": "RB1", "player": "Kenneth Walker", "position": "RB", "nflTeam": "KC", "projectedPoints": 14.6, "tier": "Tier 2", "matchupVs": "vs BAL (Thu 8:20pm)", "news": "Explosive zone runner with expanded passing-down snaps."},
                    {"slot": "RB2", "player": "Kyren Williams", "position": "RB", "nflTeam": "LAR", "projectedPoints": 15.0, "tier": "Tier 1", "matchupVs": "@ DET (Sun 8:20pm)", "news": "Monopolizes high-value red zone touches in McVay's running attack."},
                    {"slot": "WR1", "player": "Puka Nacua", "position": "WR", "nflTeam": "LAR", "projectedPoints": 16.5, "tier": "Tier 1", "matchupVs": "@ DET (Sun 8:20pm)", "news": "Elite first-read target earner in high-total Ford Field shootout."},
                    {"slot": "WR2", "player": "Jaxon Smith-Njigba", "position": "WR", "nflTeam": "SEA", "projectedPoints": 14.8, "tier": "Tier 2", "matchupVs": "vs DEN (Sun 4:05pm)", "news": "Primary slot weapon in new Ryan Grubb offensive coordinator scheme."},
                    {"slot": "TE", "player": "Isaiah Likely", "position": "TE", "nflTeam": "NYG", "projectedPoints": 7.6, "tier": "Tier 3", "matchupVs": "vs MIN (Sun 1pm)", "news": "Athletic move tight end looking to build on second-half breakout."},
                    {"slot": "FLEX1", "player": "DeVonta Smith", "position": "WR", "nflTeam": "PHI", "projectedPoints": 13.7, "tier": "Tier 2", "matchupVs": "vs GB (Fri 8:15pm)", "news": "Deep speed mismatch against secondary on Brazil kickoff night."},
                    {"slot": "FLEX2", "player": "Ladd McConkey", "position": "WR", "nflTeam": "LAC", "projectedPoints": 12.0, "tier": "Tier 3", "matchupVs": "vs LV (Sun 4:05pm)", "news": "Precise route technician in high-volume Greg Roman passing role."},
                    {"slot": "FLEX3", "player": "Blake Corum", "position": "RB", "nflTeam": "LAR", "projectedPoints": 9.1, "tier": "Tier 3", "matchupVs": "@ DET (Sun 8:20pm)", "news": "Rookie complementary punch in high-scoring Ford Field environment."},
                    {"slot": "K", "player": "Harrison Butker", "position": "K", "nflTeam": "KC", "projectedPoints": 8.5, "tier": "Tier 1", "matchupVs": "vs BAL (Thu 8:20pm)", "news": "Consistent scoring opportunities in Kansas City powerhouse offense."},
                    {"slot": "DEF", "player": "Baltimore Ravens", "position": "DEF", "nflTeam": "BAL", "projectedPoints": 7.0, "tier": "Tier 1", "matchupVs": "@ KC (Thu 8:20pm)", "news": "Turnover-forcing unit with disciplined coverage shell."}
                ]
            },
            "spread": -0.5,
        ...
        },
        {
            ...
            "teamA": {
                ...
                "impliedTotal": 125.8,
                "starters": [
                    {"slot": "QB", "player": "Joe Burrow", "position": "QB", "nflTeam": "CIN", "projectedPoints": 19.8, "tier": "Tier 1", "matchupVs": "vs NE (Sun 1pm)", "news": "Elite pocket passer healthy and ready for home opener."},
                    {"slot": "RB1", "player": "Brian Robinson", "position": "RB", "nflTeam": "ATL", "projectedPoints": 11.0, "tier": "Tier 3", "matchupVs": "vs PIT (Sun 1pm)", "news": "Early-down grinder in Atlanta backfield."},
                    {"slot": "RB2", "player": "Emmett Johnson", "position": "RB", "nflTeam": "KC", "projectedPoints": 8.0, "tier": "Tier 4", "matchupVs": "vs BAL (Thu 8:20pm)", "news": "Rotational back earning opportunities."},
                    {"slot": "WR1", "player": "Malik Nabers", "position": "WR", "nflTeam": "NYG", "projectedPoints": 15.8, "tier": "Tier 1", "matchupVs": "vs MIN (Sun 1pm)", "news": "Electric rookie wideout with 30%+ target share projection."},
                    {"slot": "WR2", "player": "Tetairoa McMillan", "position": "WR", "nflTeam": "CAR", "projectedPoints": 13.8, "tier": "Tier 2", "matchupVs": "@ NO (Sun 1pm)", "news": "Towering rookie boundary threat in Carolina."},
                    {"slot": "TE", "player": "Kyle Pitts", "position": "TE", "nflTeam": "ATL", "projectedPoints": 11.5, "tier": "Tier 2", "matchupVs": "vs PIT (Sun 1pm)", "news": "Athletic pass-catching tight end in new scheme."},
                    {"slot": "FLEX1", "player": "Luther Burden", "position": "WR", "nflTeam": "CHI", "projectedPoints": 12.2, "tier": "Tier 3", "matchupVs": "vs TEN (Sun 1pm)", "news": "Dynamic rookie with explosive run-after-catch upside."},
                    {"slot": "FLEX2", "player": "Jordyn Tyson", "position": "WR", "nflTeam": "NO", "projectedPoints": 9.5, "tier": "Tier 4", "matchupVs": "vs CAR (Sun 1pm)", "news": "Perimeter threat in New Orleans passing attack."},
                    {"slot": "FLEX3", "player": "Hunter Henry", "position": "TE", "nflTeam": "NE", "projectedPoints": 8.2, "tier": "Tier 3", "matchupVs": "@ CIN (Sun 1pm)", "news": "Veteran safety valve for rookie QB Drake Maye."},
                    {"slot": "K", "player": "Evan McPherson", "position": "K", "nflTeam": "CIN", "projectedPoints": 8.2, "tier": "Tier 1", "matchupVs": "vs NE", "news": "Money Mac with high volume in home game."},
            ...
            "tacticalAnalysis": {
                ...
                "keyVariables": [
                    ...
                    "Malik Nabers' NFL debut as Giants alpha wideout.",
                    "CeeDee Lamb in the late afternoon national window in Cleveland."
                ]
            },
            "positionalEdges": [
                {"category": "Quarterback", "advantage": "My Nabers Tetties", "margin": "+2.6 pts", "narrative": "Joe Burrow provides proven veteran elite passing volume."},
                {"category": "Running Backs", "advantage": "arkinsjt", "margin": "+6.3 pts", "narrative": "David Montgomery and Bucky Irving offer much stronger weekly floor."},
                {"category": "Wide Receivers", "advantage": "arkinsjt", "margin": "+3.4 pts", "narrative": "CeeDee Lamb and A.J. Brown are established top-5 alphas."},
                {"category": "Tight End", "advantage": "arkinsjt", "margin": "+1.3 pts", "narrative": "Travis Kelce still commands premier red zone targets in KC."},
                {"category": "FLEX & Depth", "advantage": "arkinsjt", "margin": "+2.5 pts", "narrative": "Tee Higgins and Rome Odunze give arkinsjt deep scoring power."}
            ],
            "tvSchedule": [
                {
                    "timeSlot": "Sunday 1:00 PM ET",
        ...
        },
        {
            ...
            "teamA": {
                ...
                "starters": [
                    ...
                    {"slot": "RB1", "player": "Breece Hall", "position": "RB", "nflTeam": "NYJ", "projectedPoints": 17.5, "tier": "Tier 1", "matchupVs": "@ SF (Mon 8:15pm)", "news": "Dual-threat superstar running back in prime time."},
                    {"slot": "RB2", "player": "Jeremiyah Love", "position": "RB", "nflTeam": "ARI", "projectedPoints": 12.5, "tier": "Tier 2", "matchupVs": "@ BUF (Sun 1pm)", "news": "Rookie draft centerpiece stepping into lead role."},
                    {"slot": "WR1", "player": "Jaylen Waddle", "position": "WR", "nflTeam": "DEN", "projectedPoints": 13.8, "tier": "Tier 2", "matchupVs": "@ SEA (Sun 4:05pm)", "news": "Electric deep speed in Sean Payton offense."},
                    {"slot": "WR2", "player": "Roman Wilson", "position": "WR", "nflTeam": "PIT", "projectedPoints": 9.8, "tier": "Tier 3", "matchupVs": "@ ATL (Sun 1pm)", "news": "Rookie slot receiver in Pittsburgh."},
                    {"slot": "TE", "player": "Sam LaPorta", "position": "TE", "nflTeam": "DET", "projectedPoints": 13.5, "tier": "Tier 1", "matchupVs": "vs LAR (Sun 8:20pm)", "news": "Pro Bowl tight end weapon on Sunday Night Football."},
                    {"slot": "FLEX1", "player": "Jonathon Brooks", "position": "RB", "nflTeam": "CAR", "projectedPoints": 11.2, "tier": "Tier 2", "matchupVs": "@ NO (Sun 1pm)", "news": "Highly-regarded rookie running back."},
                    {"slot": "FLEX2", "player": "Kimani Vidal", "position": "RB", "nflTeam": "LAC", "projectedPoints": 9.0, "tier": "Tier 4", "matchupVs": "vs LV (Sun 4:05pm)", "news": "Rotational back in Chargers ground game."},
                    {"slot": "FLEX3", "player": "Tyler Allgeier", "position": "RB", "nflTeam": "ARI", "projectedPoints": 8.0, "tier": "Tier 4", "matchupVs": "@ BUF (Sun 1pm)", "news": "Goal-line power back."},
                    {"slot": "K", "player": "Tyler Bass", "position": "K", "nflTeam": "BUF", "projectedPoints": 7.6, "tier": "Tier 2", "matchupVs": "vs ARI", "news": "High scoring offense kicker."},
    ...
    total_proj = sum(m["teamA"]["projectedScore"] + m["teamB"]["projectedScore"] for m in matchups)
