...
def build_redraft_recap():
    ...
    POWER_RANK_HISTORY = {
        8: {  # mannyrsox24
            ...
            "preSeasonScore": 96.8, "kickoffScore": 96.0, "currentScore": 93.1,
            "rankDelta": 0, "scoreDelta": -3.7,
            "headline": "Jeanty and Hubbard shine in Week 1 despite tough 101.4–109.5 loss to DRockefeller",
            "commentary": "Maintains the #1 overall power rank entering Week 2 on the foundation of an exceptional young roster. Ashton Jeanty's 29.7-point explosion and Chuba Hubbard's 22.2 points confirmed a league-best backfield ceiling, but zero points from tight end Colston Loveland and a quiet 2.4-point day from Terry McLaurin resulted in an 8.2-point loss to DRockefeller. With Jayden Daniels steady at QB (17.7 pts), this team remains the premier championship favorite.",
            "keyDrivers": [
                "Ashton Jeanty exploded for 29.7 pts in electric rookie debut",
                "Chuba Hubbard provided 22.2 pts of high-end RB efficiency",
                "TE/WR floor concerns: Colston Loveland (0.0 pts) & Terry McLaurin (2.4 pts)",
                "Retains #1 composite power index (93.1) heading into Week 2",
            ],
        },
        5: {  # arkinsjt
            "preSeasonRank": 2, "kickoffRank": 2, "currentRank": 3,
            "preSeasonScore": 93.2, "kickoffScore": 93.4, "currentScore": 83.7,
            "rankDelta": -1, "scoreDelta": -9.5,
            "headline": "Balanced attack delivers 142.0-point blowout win; holds #3 rank",
            "commentary": "Cruised to an emphatic 142.0–106.6 victory over kong58, demonstrating rare roster depth. Four different starters topped 21 points (Zay Flowers 23.5, Chris Olave 23.2, Javonte Williams 21.7, Jalen Hurts 24.7), overcoming a rare 2.2-point opening day from Ja'Marr Chase. Sits securely in the top-three tier with weekly scoring power.",
            "keyDrivers": [
                "Surged to 142.0 points behind balanced multi-position explosion",
                "Zay Flowers (23.5 pts) and Chris Olave (23.2 pts) paced receiver room",
                "Jalen Hurts delivered 24.7 pts; Javonte Williams added 21.7 pts",
                "Overcame Ja'Marr Chase's quiet 2.2-point opener with ease",
            ],
        },
        6: {  # Gnomeington
            "preSeasonRank": 3, "kickoffRank": 3, "currentRank": 2,
            "preSeasonScore": 89.5, "kickoffScore": 89.2, "currentScore": 89.1,
            "rankDelta": 1, "scoreDelta": -0.4,
            "headline": "Allen & Gibbs powerhouse fuels 133.9-point rout of akwelch3492; claims #2 rank",
            "commentary": "Climbed to #2 in the power rankings after rolling to an emphatic 133.9–112.5 win over akwelch3492. Josh Allen (35.7 pts) and Jahmyr Gibbs (31.1 pts) formed an unstoppable one-two punch, while an elite 95.4% lineup efficiency masked a zero from Kyle Pitts. Ranks #2 in optimal weekly projection (125.1 pts/wk) with a balanced, high-floor roster.",
            "keyDrivers": [
                "Josh Allen (35.7 pts) and Jahmyr Gibbs (31.1 pts) dominated Week 1",
                "League-high 95.4% lineup efficiency in Week 1 victory",
                "DJ Moore (18.5 pts) and Nico Collins (17.7 pts) anchored WR room",
                "Elevated to #2 overall in composite power index (89.1)",
            ],
        },
        4: {  # kong58
            "preSeasonRank": 5, "kickoffRank": 5, "currentRank": 4,
            "preSeasonScore": 83.5, "kickoffScore": 83.8, "currentScore": 81.1,
            "rankDelta": 1, "scoreDelta": -2.4,
            "headline": "Top-4 tier holds steady despite Week 1 buzzsaw loss to arkinsjt",
            "commentary": "Retains the #4 power ranking despite a 142.0–106.6 defeat to arkinsjt. Brock Purdy (22.1 pts) and Breece Hall (18.8 pts) provided a dependable scoring floor, but uncharacteristically quiet outings from Davante Adams (4.1 pts) and George Kittle (2.2 pts) stalled any comeback. Roster balance (96.0) keeps them firmly in playoff contention.",
            "keyDrivers": [
                "Brock Purdy (22.1 pts) and Breece Hall (18.8 pts) led scoring floor",
                "Davante Adams (4.1 pts) and George Kittle (2.2 pts) underperformed expectations",
                "Christian McCaffrey returned 11.3 pts; balance score of 96.0 protects ranking",
                "Secures #4 position in power index (81.1) entering Week 2",
            ],
        },
        12: {  # rLee3D
            "preSeasonRank": 6, "kickoffRank": 4, "currentRank": 9,
            "preSeasonScore": 80.2, "kickoffScore": 81.9, "currentScore": 70.8,
            "rankDelta": -3, "scoreDelta": -9.4,
            "headline": "League-high 162.2-point Week 1 explosion sends warning shot to contenders",
            "commentary": "Paced the entire Craig Invitational with a staggering 162.2 points in a 59.1-point demolition of jccbraves99. Kenneth Walker (32.6 pts), Christian Watson (29.7 pts), David Montgomery (27.4 pts), and Lamar Jackson (25.0 pts) all cleared 24 points. While baseline model depth keeps them at #9 currently, repeated starter execution will quickly propel them upward.",
            "keyDrivers": [
                "Week 1 high scorer across all 12 teams with 162.16 points",
                "Four starters eclipsed 24+ points: Walker (32.6), Watson (29.7), Montgomery (27.4), Lamar (25.0)",
                "Achieved 96.1% lineup efficiency in Week 1 rout",
                "Power score at 70.8; carries league's highest scoring momentum",
            ],
        },
        9: {  # mtrebing31
            "preSeasonRank": 4, "kickoffRank": 6, "currentRank": 7,
            "preSeasonScore": 84.2, "kickoffScore": 80.1, "currentScore": 75.6,
            "rankDelta": -3, "scoreDelta": -8.6,
            "headline": "Scoring explosion (157.2 pts) fuels momentum after Week 1 masterclass",
            "commentary": "Delivered a sensational 157.2 points—the second-highest total of Week 1—in a 47.2-point blowout of mdwelch11. D'Andre Swift (31.9 pts) and rookie Jaxson Dart (26.6 pts) torched expectations, while Evan McPherson added a rare 20.5 points from kicker. While season-long depth models keep their baseline at #7, this lineup's weekly ceiling is unquestioned.",
            "keyDrivers": [
                "D'Andre Swift (31.9 pts) and Jaxson Dart (26.6 pts) exploded in Week 1",
                "Evan McPherson contributed 20.5 kicking points; Ladd McConkey added 16.7",
                "Second-highest point total in the Craig Invitational (157.2 pts)",
                "90.6% lineup efficiency in Week 1 blowout victory",
            ],
        },
        3: {  # DRockefeller
            "preSeasonRank": 7, "kickoffRank": 7, "currentRank": 6,
            "preSeasonScore": 79.5, "kickoffScore": 79.0, "currentScore": 75.9,
            "rankDelta": 1, "scoreDelta": -3.6,
            "headline": "Taylor and Steelers defense secure 109.5-point upset over #1 mannyrsox24",
            "commentary": "Climbed to #6 following an upset 109.5–101.4 Week 1 victory over #1 ranked mannyrsox24. Jonathan Taylor (23.6 pts) and a ferocious Steelers defense (20.0 pts) carried the scoring load, overcoming quiet debuts from Drake London (4.5 pts) and Marvin Harrison Jr. (3.8 pts) alongside Drake Maye's 12.8-point starting quarterback nod.",
            "keyDrivers": [
                "Jonathan Taylor (23.6 pts) and Steelers D/ST (20.0 pts) sparked upset",
                "Drake Maye managed 12.8 pts in his starting quarterback debut",
                "Top wideouts Drake London (4.5 pts) and Marvin Harrison (3.8 pts) due for positive regression",
                "Secured 1-0 record and climbed +1 spot to #6 in power rankings",
            ],
        },
        10: {  # akwelch3492
            "preSeasonRank": 8, "kickoffRank": 8, "currentRank": 10,
            "preSeasonScore": 76.5, "kickoffScore": 76.4, "currentScore": 69.5,
            "rankDelta": -2, "scoreDelta": -7.0,
            "headline": "Caleb Williams (37.3 pts) & Jefferson dazzle, but thin depth costs Week 1",
            "commentary": "Slips two spots to #10 following a 133.9–112.5 loss to Gnomeington. Caleb Williams erupted for 37.3 points and Justin Jefferson tallied 27.2 points, but zero other starter crossed 12 points. Shallow bench depth and minimal RB output (Pollard 3.9, Lloyd 3.7) highlight the gap between starting ceiling and roster floor.",
            "keyDrivers": [
                "Caleb Williams posted the highest QB score of Week 1 (37.3 pts)",
                "Justin Jefferson dominated with 27.2 pts",
                "K/DEF combined for just 2.0 total points (Mevis 1.0, LAC 1.0)",
                "Backfield and flex deficits drag power rating to 69.5",
            ],
        },
        7: {  # bubberdubber
            "preSeasonRank": 9, "kickoffRank": 9, "currentRank": 5,
            "preSeasonScore": 75.8, "kickoffScore": 76.0, "currentScore": 76.2,
            "rankDelta": 4, "scoreDelta": 0.4,
            "headline": "Climbs +4 spots into top-5 tier after impressive 121.9-point win",
            "commentary": "The biggest riser across the entire league, jumping four spots to #5 following a convincing 121.9–98.4 victory against sduda351. Trevor Lawrence (26.1 pts) was sharp, Jaxon Smith-Njigba commanded targets for 22.2 pts, and Trey McBride paced all tight ends with 20.0 pts. Strong 93.3% lineup efficiency overcame a -1.0 from Houston's defense.",
            "keyDrivers": [
                "Trevor Lawrence posted 26.1 pts; JSN broke out with 22.2 pts",
                "Trey McBride dominated tight end position with 20.0 pts",
                "Lineup efficiency clocked in at 93.3% in Week 1 victory",
                "Biggest mover in the league: leaped from #9 to #5 overall (76.2 score)",
            ],
        },
        11: {  # mdwelch11
            "preSeasonRank": 10, "kickoffRank": 10, "currentRank": 8,
            "preSeasonScore": 76.0, "kickoffScore": 76.1, "currentScore": 72.1,
            "rankDelta": 2, "scoreDelta": -3.9,
            "headline": "Henry & Amon-Ra combine for 58.5 pts, but secondary pieces fall flat in loss",
            "commentary": "Moved up to #8 in the power index despite falling 157.2–110.0 to a red-hot mtrebing31. Derrick Henry (34.8 pts) and Amon-Ra St. Brown (23.7 pts) proved their elite star power, but support evaporated with Brandon Aubrey (1.0 pt), Rams defense (2.0 pts), and Samaje Perine (6.5 pts). Stabilizing the flex and defensive slots is vital for Week 2.",
            "keyDrivers": [
                "Derrick Henry turned in a monstrous 34.8-point performance",
                "Amon-Ra St. Brown commanded targets for 23.7 pts",
                "Aubrey (1.0 pt) and Rams D/ST (2.0 pts) heavily limited lineup floor",
                "Composite power score stands at 72.1 entering Week 2",
            ],
        },
        1: {  # jccbraves99
            "preSeasonRank": 11, "kickoffRank": 11, "currentRank": 11,
            "preSeasonScore": 74.5, "kickoffScore": 74.3, "currentScore": 68.4,
            "rankDelta": 0, "scoreDelta": -6.1,
            "headline": "Bijan's 27.3-point clinic overshadowed by 103.0-point Week 1 stumble",
            "commentary": "Remains at #11 following a 162.2–103.0 loss to rLee3D. Bijan Robinson was exceptional with 27.3 points and Parker Washington added 16.8, but single-digit outings from Bo Nix (6.4 pts), A.J. Brown (4.1 pts), and Jaylen Waddle (0.7 pt) stalled the offense. Rebound performances from his receiving corps are required in Week 2.",
            "keyDrivers": [
                "Bijan Robinson showcased RB1 dominance with 27.3 points",
                "Quiet days from A.J. Brown (4.1 pts) and Jaylen Waddle (0.7 pt)",
                "Bo Nix struggled at QB (6.4 pts); receiver rebound needed",
                "Power index holds at 68.4 entering Week 2",
            ],
        },
        2: {  # sduda351
            "preSeasonRank": 12, "kickoffRank": 12, "currentRank": 12,
            "preSeasonScore": 67.0, "kickoffScore": 66.5, "currentScore": 58.9,
            "rankDelta": 0, "scoreDelta": -8.1,
            "headline": "Sub-100 opening week cements #12 rank; youth movement seeks Week 2 bounce",
            "commentary": "Remains at #12 after scoring a league-low 98.4 points in a 121.9–98.4 loss to bubberdubber. Isaiah Likely was the lone bright spot with 23.8 points, but the young receiving corps struggled to create separation (Fields 3.5, Concepcion 5.8, Metcalf 6.0). With young developmental pieces across the roster, patience is required.",
            "keyDrivers": [
                "Isaiah Likely paced the squad with 23.8 points at tight end",
                "Only team held under 100 points in Week 1 (98.44 pts)",
                "Wide receiver room combined for under 16 total starting points",
                "Holds #12 rank with 58.9 power index heading into Week 2",
            ],
        },
    }
    ...
    power_milestones = [
        ...
        {"id": "week1_final", "label": "Week 1 Final Audit", "date": "2026-09-16", "description": "Post-Week 1 box scores, actual lineup efficiency, and Week 2 power trajectory"},
    ]
    ...
    for row in power_rankings:
        ...
        row["powerTrend"] = {
            ...
            "trajectory": [
                ...
                {"milestone": "Week 1 Final Audit", "date": "2026-09-16", "rank": cur_r, "score": cur_s},
            ],
        }
...
def build_redraft_forecast(team_data, power_rankings, sleeper_schedule, current_week=1, matchup_payload=None):
    ...
    for profile in profiles:
        ...
        trajectory = [
            ...
            {
                "milestone": "Week 1 Final Audit",
                "date": "2026-09-16",
                "expectedWins": expected_wins,
                "playoffOdds": playoff_probability,
                "rank": profile["rank"],
                "event": "Week 1 Final Audit & Efficiency",
            },
        ]
